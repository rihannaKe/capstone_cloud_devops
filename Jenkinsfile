node {
    ...
    stage('Building image') {
        ...
        withCredentials([usernamePassword(credentialsId: 'dockerhub', passwordVariable: 'Android85', usernameVariable: 'rihannadocker')]) {
	     	sh "docker login -u ${usernameVariable} -${passwordVariable} "
